...
#plt.show() # 也可以直接用到這裏下面註解，只用matplotlib跟pandas
# 如果用wsl 要有x11-apps VcXsrv
from plotly.offline.offline import plot_mpl
plot_mpl(fig.get_figure(), filename='ar.html', auto_open=False)
